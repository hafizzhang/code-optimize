 ...
 */
@Component
public class FullCutCampaignHandler implements ICampaignHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(FullCutCampaignHandler.class);
    ...
    public CampaignTypeEnum getCampaignType() {
        return CampaignTypeEnum.FULL_CUT;
    }

    @Override
    public String calculate() {
        LOGGER.info("满减活动计算毛利率");
        return "满减活动计算毛利率";
    }
}
